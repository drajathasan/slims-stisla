...
require STISLA_DIR . 'lib/StislaModule.php';
...
if ($current_module AND $can_read) {
    ...
    include STISLA_DIR . 'pages/admin/default/dashboard.php';
...
if (file_exists($path_template = $sysconf['admin_template']['dir'].'/'.$sysconf['admin_template']['theme'].'/index_template.inc.php')) {
    require $path_template;
} else {
    require STISLA_TEMPLATE . $sysconf['admin_template']['theme'].'/index_template.inc.php';
}
exit;